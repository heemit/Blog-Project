    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(default='/home/admin/project/blog/web/static/images/default_image.jpeg', help_text='A thumbnail image for the blog post.', upload_to='blog/')),
                ('featured_text', tinymce.models.HTMLField(blank=True, help_text='A featured text or excerpt from the blog, with rich text support.', null=True)),
                ('text', tinymce.models.HTMLField(blank=True, help_text='The main content of the blog post, with rich text support.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='The title of the blog post.', max_length=200)),
                ('sub_title', models.CharField(blank=True, help_text='An optional subtitle for the blog post.', max_length=200, null=True)),
                ('thumbnail', models.TextField(default='/home/admin/project/blog/web/static/images/default_image.jpeg', help_text='A thumbnail image for the blog post.', max_length=100)),
                ('featured_text', tinymce.models.HTMLField(blank=True, help_text='A featured text or excerpt from the blog, with rich text support.', null=True)),
                ('text', tinymce.models.HTMLField(blank=True, help_text='The main content of the blog post, with rich text support.', null=True)),
